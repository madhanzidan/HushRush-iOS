...
class OnboardingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        slides = [
            ...
            OnboardingSlide(title: "Sistem Keamanan Anti-tipu", description: "Kami menggunakan PIN dan Face ID/Touch ID untuk menonaktifkan alarm untuk memastikan bahwa itu benar-benar anda.", image: #imageLiteral(resourceName: "thirdOnboarding"))
